...
router.post('/:idTalent',  multer({ storage: storage , 
  ...
  console.log("fffffffffffffffffffff", req.body.nom)
  ...
  var nom = req.body.nom +'_'+ rd['username']+'.'+ext;
...
router.put("/updateDocument/:id",
  ...
  console.log("str:   ", str);
  var pos = str.indexOf('uploads/')+8;
  var nom = str.substring(pos,str.lenght);
...
//   http://localhost:3000/api/talents/document/document/5d41827decde4708702abf91
// GET ALL Document Talent By Talent Id
router.get("/document/:idTalent", (req, res, next) => {
