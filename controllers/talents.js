        ...
        if (err) {
            ...
            var transporter = nodemailer.createTransport({
              ...
              var mailOptions = {
                ...
                html: "<p> Bonjour   "+ (req.body.username) + ",<br> <p> Bienvenue chez notre plateforme Arrimer  <B> <br><p> Vos infomrations d'authentification sont : <br><p> Username :  " +" "+ req.body.username +"<br><p> Mot De Passe : "+" "+ req.body.password
              };
...
router.get('/getAllTalents', ( req, res) => {
    Talent.find({"statut": "Activé"},{password:0} ,(err, docs) => {
        if (!err) { res.send(docs); }
        else { console.log('Erreur :' + JSON.stringify(err, undefined, 2)); }
    });
});
...
router.put('/updateTalentById/:id',(req, res) =>{
    ...
    Talent.updateTalent(talent, (err, user) => {
